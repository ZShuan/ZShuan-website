...
export default function CesiumGlobe({ goTo, goToCity, transitionMode = false, scrollProgress = 0, scrollY: scrollYProp, activeStage = -1, stageAnimating = true, isCityMode = false, onUserInteract, cityPoints: cityPointsProp = [] }) {
  ...
  // 地图风格状态
  const [mapStyle, setMapStyle] = useState('local'); // 默认本地贴图，避免在线瓦片卡顿
